...
export const uiClasses = {
  ...
  sidebar: "border-b border-stone-300/90 bg-[#f8f1e6] p-5 md:border-r md:border-b-0",
  ...
  dashedCard: "rounded-xl border border-dashed border-stone-300 bg-[#fffcf7] p-4 text-sm text-slate-600",
  ...
  darkCodeBlock: "overflow-x-auto rounded-lg bg-slate-800 p-3 text-xs text-slate-50 whitespace-pre-wrap break-words",
};
